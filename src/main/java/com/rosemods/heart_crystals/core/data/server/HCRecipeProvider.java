...
public class HCRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(HCItems.HEART_CRYSTAL_SHARD.get(), 9).requires(HCBlocks.HEART_CRYSTAL.get()).unlockedBy(getHasName(HCBlocks.HEART_CRYSTAL.get()), has(HCBlocks.HEART_CRYSTAL.get())).save(consumer, getSaveLocation(HCItems.HEART_CRYSTAL_SHARD));
