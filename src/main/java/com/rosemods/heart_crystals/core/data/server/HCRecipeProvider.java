...
public class HCRecipeProvider extends BlueprintRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput output) {
        ...
        conditionalRecipe(output, new TagEmptyCondition(ResourceLocation.fromNamespaceAndPath("forge", "ingots/silver")), RecipeCategory.DECORATIONS, ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, HEART_LANTERN.get()).define('#', HEART_CRYSTAL.get()).define('I', Items.IRON_INGOT).pattern("I").pattern("#").pattern("I").unlockedBy(getHasName(HEART_CRYSTAL.get()), has(HEART_CRYSTAL.get())));
        conditionalRecipe(output, new NotCondition(new TagEmptyCondition(ResourceLocation.fromNamespaceAndPath("forge", "ingots/silver"))), RecipeCategory.DECORATIONS, ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, HEART_LANTERN.get()).define('#', HEART_CRYSTAL.get()).define('I', TagUtil.itemTag("forge", "ingots/silver")).pattern("I").pattern("#").pattern("I").unlockedBy(getHasName(HEART_CRYSTAL.get()), has(HEART_CRYSTAL.get())), HeartCrystals.location("heart_lantern_from_silver"));
    }
