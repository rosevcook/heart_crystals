...
public final class HCFeatures {
    ...
    public static final class Placements {
        ...
        public static final RegistryObject<PlacedFeature> HEART_CRYSTAL = register("heart_crystal", Features.HEART_CRYSTAL, CountPlacement.of(1), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
